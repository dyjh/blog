		...
		?> 
			<div class="featured-item">
				<div class="featured-media">
					...
					<img width="830" height="554" src="<?php echo get_template_directory_uri(); ?>/timthumb.php?src=<?php echo xintheme_thumb(); ?>&w=830&h=554&zc=1" class="attachment-large size-large wp-post-image" alt="<?php the_title(); ?>"/>
					<?php } else { } ?>
...
<script type='text/javascript' src='<?php bloginfo('template_directory'); ?>/js/init-carousel-2.js'></script>
<?php } ?>
