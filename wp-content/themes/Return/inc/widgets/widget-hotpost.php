...
class xintheme_hotpost extends WP_Widget {
    ...
    function xintheme_hotpost() {
        $widget_ops = array('description' => '默认显示3个月内，评论数最多的图文列表');
        $this->__construct('xintheme_hotpost', '热评文章（图文） ', $widget_ops);
    }
    ...
    function widget($args, $instance) {
        ...
        echo dahuzi2_widget_hotpost($limit,$cat,$time);
        echo $after_widget;	
    }
...
function dahuzi2_widget_hotpost($limit,$cat,$time){ 
?>
		...
		<ul class="hots-post-widget">
			...
			<div class="post-item-media">
				<a class="post-item-thumbnail" href="<?php the_permalink(); ?>" aria-hidden="true">
					<img src="<?php echo get_template_directory_uri(); ?>/timthumb.php?src=<?php echo xintheme_thumb(); ?>&w=150&h=150&zc=1" alt="<?php the_title(); ?>" width="150" height="150">
				</a>
			</div>
